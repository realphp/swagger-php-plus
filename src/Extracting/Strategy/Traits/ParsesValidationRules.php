...
use RealPHP\SwaggerPhpPlus\Exceptions\CouldntProcessValidationRule;
use RealPHP\SwaggerPhpPlus\Exceptions\ProblemParsingValidationRules;
    ...
    public function getParametersFromValidationRules(array $validationRulesByParameters, array $customParameterData = []): array
    {
        ...
        foreach ($validationRulesByParameters as $parameter => $ruleset) {
            ...
            try {
                ...
                if ($e instanceof SwaggerPhpPlusException) {
